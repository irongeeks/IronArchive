...
-- Description: Create core database schema for IronArchive
-- Created: 2025-10-17
-- ============================================================================

-- ============================================================================
-- SECTION 1: Enable PostgreSQL Extensions
-- ============================================================================

-- UUID generation support
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Encryption support for sensitive data (Azure credentials)
...
-- ----------------------------------------------------------------------------
-- Table: tenants
-- Description: MSP customers with M365 tenant configuration
-- Dependencies: None
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- Table: mailboxes
-- Description: M365 mailboxes configured for backup
-- Dependencies: tenants
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- Table: emails
-- Description: Archived email messages with metadata
...
CREATE TABLE emails (
    ...
    body_text TEXT, -- Plain text body for full-text search and legal discovery
    body_html TEXT, -- HTML body for display and archival
...
-- ----------------------------------------------------------------------------
-- Table: attachments
-- Description: Email attachments with deduplication
-- Dependencies: emails
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- Table: jobs
-- Description: Background job tracking (sync, export, retention)
-- Dependencies: tenants, mailboxes, users
-- ----------------------------------------------------------------------------
CREATE TABLE jobs (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    ...
    error_message TEXT, -- Stores failure details for diagnostics and audit
    metadata JSONB,
...
-- Description: Ensures audit logs are immutable (cannot be updated or deleted)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- Trigger: audit_log_immutable_trigger
-- Description: Prevents any UPDATE or DELETE operations on audit_logs table
-- ----------------------------------------------------------------------------
...
-- Description: Automatically updates users.updated_at on row modification
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- Initial settings records
-- Description: Default configuration values for the application
-- ----------------------------------------------------------------------------
